...
```
ava-github-skill/
├── SKILL.md       # Skill documentation for AVA
├── README.md      # This file
...
**Do:**
- ✅ Use environment variables or AVA config
...
- For shared machines: Use AVA config or a secrets manager
